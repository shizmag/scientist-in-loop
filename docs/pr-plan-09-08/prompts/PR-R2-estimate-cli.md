...
Ship ONLY PR-R2. See parent plan §8 for full requirements.

## Goal

Estimate CLI as specified in `docs/pr-plan-09-08/pr-plan.md`.
...
4. Complete acceptance criteria in parent plan for PR-R2.

## Out of scope

Anything not listed for PR-R2 in the parent plan.

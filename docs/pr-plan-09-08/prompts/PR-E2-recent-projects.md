...
Ship ONLY PR-E2. See parent plan §8 for full requirements.

## Goal

Recent projects as specified in `docs/pr-plan-09-08/pr-plan.md`.
...
4. Complete acceptance criteria in parent plan for PR-E2.

## Out of scope

Anything not listed for PR-E2 in the parent plan.

# PR-C2 — MCP promote/split

Parent design: [../pr-plan.md](../pr-plan.md).

## Role

Ship ONLY PR-C2. See parent plan §8 for full requirements.

## Goal

MCP promote/split as specified in `docs/pr-plan-09-08/pr-plan.md`.
...
4. Complete acceptance criteria in parent plan for PR-C2.

## Out of scope

Anything not listed for PR-C2 in the parent plan.

# PR-E4 — Handlers split

Parent design: [../pr-plan.md](../pr-plan.md).

## Role

Ship ONLY PR-E4. See parent plan §8 for full requirements.

## Goal

Handlers split as specified in `docs/pr-plan-09-08/pr-plan.md`.
...
4. Complete acceptance criteria in parent plan for PR-E4.

## Out of scope

Anything not listed for PR-E4 in the parent plan.

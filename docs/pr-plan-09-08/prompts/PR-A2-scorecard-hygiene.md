...
Ship ONLY PR-A2. See parent plan §8 for full requirements.

## Goal

Scorecard hygiene as specified in `docs/pr-plan-09-08/pr-plan.md`.
...
4. Complete acceptance criteria in parent plan for PR-A2.

## Out of scope

Anything not listed for PR-A2 in the parent plan.

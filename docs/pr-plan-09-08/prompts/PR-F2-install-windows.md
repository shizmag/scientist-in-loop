# PR-F2 — Install Windows

Parent design: [../pr-plan.md](../pr-plan.md).

## Role

Ship ONLY PR-F2. See parent plan §8 for full requirements.

## Goal

Install Windows as specified in `docs/pr-plan-09-08/pr-plan.md`.
...
4. Complete acceptance criteria in parent plan for PR-F2.

## Out of scope

Anything not listed for PR-F2 in the parent plan.

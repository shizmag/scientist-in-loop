...
Ship ONLY PR-E3. See parent plan §8 for full requirements.

## Goal

MCP tools split as specified in `docs/pr-plan-09-08/pr-plan.md`.
...
4. Complete acceptance criteria in parent plan for PR-E3.

## Out of scope

Anything not listed for PR-E3 in the parent plan.

...
Ship ONLY PR-E1. See parent plan §8 for full requirements.

## Goal

Keymap audit as specified in `docs/pr-plan-09-08/pr-plan.md`.
...
4. Complete acceptance criteria in parent plan for PR-E1.

## Out of scope

Anything not listed for PR-E1 in the parent plan.

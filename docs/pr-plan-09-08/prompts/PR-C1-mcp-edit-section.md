# PR-C1 — MCP edit section

Parent design: [../pr-plan.md](../pr-plan.md).

## Role

Ship ONLY PR-C1. See parent plan §8 for full requirements.

## Goal

MCP edit section as specified in `docs/pr-plan-09-08/pr-plan.md`.
...
4. Complete acceptance criteria in parent plan for PR-C1.

## Out of scope

Anything not listed for PR-C1 in the parent plan.

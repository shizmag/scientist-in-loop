...
Ship ONLY PR-G2. See parent plan §8 for full requirements.

## Goal

Paper pack as specified in `docs/pr-plan-09-08/pr-plan.md`.
...
4. Complete acceptance criteria in parent plan for PR-G2.

## Out of scope

Anything not listed for PR-G2 in the parent plan.

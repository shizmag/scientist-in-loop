...
Ship ONLY PR-G1. See parent plan §8 for full requirements.

## Goal

Assets registry as specified in `docs/pr-plan-09-08/pr-plan.md`.
...
4. Complete acceptance criteria in parent plan for PR-G1.

## Out of scope

Anything not listed for PR-G1 in the parent plan.

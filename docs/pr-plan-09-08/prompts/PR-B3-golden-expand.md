...
Ship ONLY PR-B3. See parent plan §8 for full requirements.

## Goal

Golden expand as specified in `docs/pr-plan-09-08/pr-plan.md`.
...
4. Complete acceptance criteria in parent plan for PR-B3.

## Out of scope

Anything not listed for PR-B3 in the parent plan.

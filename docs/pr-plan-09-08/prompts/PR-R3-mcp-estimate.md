...
Ship ONLY PR-R3. See parent plan §8 for full requirements.

## Goal

MCP estimate as specified in `docs/pr-plan-09-08/pr-plan.md`.
...
4. Complete acceptance criteria in parent plan for PR-R3.

## Out of scope

Anything not listed for PR-R3 in the parent plan.

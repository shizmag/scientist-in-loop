...
Ship ONLY PR-R1. See parent plan §8 for full requirements.

## Goal

Review skill as specified in `docs/pr-plan-09-08/pr-plan.md`.
...
4. Complete acceptance criteria in parent plan for PR-R1.

## Out of scope

Anything not listed for PR-R1 in the parent plan.

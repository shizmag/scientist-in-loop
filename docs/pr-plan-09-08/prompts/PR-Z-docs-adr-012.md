...
Ship ONLY PR-Z. See parent plan §8 for full requirements.

## Goal

Docs ADR-012 as specified in `docs/pr-plan-09-08/pr-plan.md`.
...
4. Complete acceptance criteria in parent plan for PR-Z.

## Out of scope

Anything not listed for PR-Z in the parent plan.

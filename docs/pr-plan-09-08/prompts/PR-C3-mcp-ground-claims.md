# PR-C3 — MCP ground claims

Parent design: [../pr-plan.md](../pr-plan.md).

## Role

Ship ONLY PR-C3. See parent plan §8 for full requirements.

## Goal

MCP ground claims as specified in `docs/pr-plan-09-08/pr-plan.md`.
...
4. Complete acceptance criteria in parent plan for PR-C3.

## Out of scope

Anything not listed for PR-C3 in the parent plan.

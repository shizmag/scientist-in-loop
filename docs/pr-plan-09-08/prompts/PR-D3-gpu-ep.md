# PR-D3 — GPU EP stretch

Parent design: [../pr-plan.md](../pr-plan.md).

## Role

Ship ONLY PR-D3. See parent plan §8 for full requirements.

## Goal

GPU EP stretch as specified in `docs/pr-plan-09-08/pr-plan.md`.
...
4. Complete acceptance criteria in parent plan for PR-D3.

## Out of scope

Anything not listed for PR-D3 in the parent plan.

...
Ship ONLY PR-R4. See parent plan §8 for full requirements.

## Goal

TUI estimate as specified in `docs/pr-plan-09-08/pr-plan.md`.
...
4. Complete acceptance criteria in parent plan for PR-R4.

## Out of scope

Anything not listed for PR-R4 in the parent plan.

...
Ship ONLY PR-F1. See parent plan §8 for full requirements.

## Goal

GitHub Releases as specified in `docs/pr-plan-09-08/pr-plan.md`.
...
4. Complete acceptance criteria in parent plan for PR-F1.

## Out of scope

Anything not listed for PR-F1 in the parent plan.

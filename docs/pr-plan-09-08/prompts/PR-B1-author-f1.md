# PR-B1 — Parent author F1

Parent design: [../pr-plan.md](../pr-plan.md).

## Role

Ship ONLY PR-B1. See parent plan §8 for full requirements.

## Goal

Parent author F1 as specified in `docs/pr-plan-09-08/pr-plan.md`.
...
4. Complete acceptance criteria in parent plan for PR-B1.

## Out of scope

Anything not listed for PR-B1 in the parent plan.

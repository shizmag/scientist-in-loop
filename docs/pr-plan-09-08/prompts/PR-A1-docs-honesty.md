...
Ship ONLY PR-A1. See parent plan §8 for full requirements.

## Goal

Docs honesty as specified in `docs/pr-plan-09-08/pr-plan.md`.
...
4. Complete acceptance criteria in parent plan for PR-A1.

## Out of scope

Anything not listed for PR-A1 in the parent plan.
